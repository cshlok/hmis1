...
from .models import Bill, BillLineItem, Payment, ServiceCatalog, DepartmentBudget
...
class BillViewSet(TenantScopedViewSet):
    ...
    def set_discount(self, request, pk=None):
        ...
        try:
            ...
            raise PermissionDenied("Invalid discount") from None
        if discount_cents < 0:
            raise PermissionDenied("Invalid discount") from None
...
class AccountingViewSet(TenantScopedViewSet):
    ...
    def export_tally_xml(self, request):
        ...
        etree.SubElement(import_data, "REQUESTDESC")
